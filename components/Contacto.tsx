...
export const Contacto = () => {
    ...
    return (
        <section
            ref={containerRef}
            id="contacto"
            className={`w-full relative z-10 py-10 border-t border-white/5 overflow-hidden ${geist.className}`}
        >
            {/* Fondo decorativo (Spotlight) */}
            

            <div className="max-w-7xl mx-auto px-6 relative z-10">

                {/* Cabecera */}
                <div className="mb-16 md:mb-24 md:text-left contact-reveal">
                ...
                <div
                    ...
                    <div className="lg:col-span-2 contact-reveal animate-contact-section">
                        <div className="bg-zinc-900 ring ring-white/20 p-8 md:p-10 rounded-2xl relative overflow-hidden group">
                            ...
                            <div className="absolute inset-0 rounded-3xl transition-colors duration-500 pointer-events-none" />
